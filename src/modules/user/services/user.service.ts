...
export default class UserService {
  ...
  async isAuthorized(url: string, userId: number, componentId: number, type: string, isAuthorizedPerson?: boolean) {
  ...
  where 
    ...
    //console.log("Authroized Role Feature", authorizedRoleFeature);
    // (await (await pool).query(query, [userId, componentId, url])).rows
